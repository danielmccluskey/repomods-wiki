...
- **Vanilla Cosmetic Location**: `Assets/REPO/Game/Resources/cosmetics` you can simple copy a prefab to your mod folder.
...
3. Configure all properties:
   ...
   - **Prefab Ref**: Reference to your prefab (Drag & Drop, can be located outside mod folder)
     - To reduce RAM usage, leave the prefab field empty and use this instead then add your prefab to the `Mod` asset under `Extra Bundle Files`.

## 3. Create the Vanilla Cosmetic Asset

1. Right-click in your mod folder (or subfolder)
2. Select `Create > Cosmetics > Cosmetic Asset`
3. Configure the following fields:
   - **Asset Name**: Display name (e.g., "Big Hat")
   - **Type**: The type of the cosmetic
   - **Rarity**: The rarity of the cosmetic
   - **Custom Type List**: Custom types
   - **Disabled Type List**: Types to unequip
   - **Disabled Custom Type List**: Custom types to unequip
   - **Disabled Cosmetics**: Cosmetics to unequip

<details>
<summary><strong>Custom Type List - Click to Expand</strong></summary>
