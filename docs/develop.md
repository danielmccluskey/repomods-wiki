...
If your mod needs to change how the game functions, or requires custom logic, you'll need to write some C# scripts. This workflow relies on BepInEx and HarmonyX to patch and modify the game's code directly.
