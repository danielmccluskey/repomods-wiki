...
[**R.E.P.O.**](https://store.steampowered.com/app/3241660/REPO/) is an online co-op horror game that allows up to six players to collaborate in locating and extracting valuable, fully physics-based objects. Players must handle these items with care as they retrieve and extract them to satisfy their creator's desires.
...
1. **Get a Mod Manager**:
   ...
   **We recommend using either Gale or r2modman.**
   ...
   ::: danger MANUAL MOD INSTALLATION
   **Manual installation of mods is NOT recommended at all!** You will not receive any support in our Community Discord server!
   :::

2. **Install and open your mod manager**:
   Download, install, and launch your preferred mod manager.

3. **Select R.E.P.O. and install mods**:
Choose **R.E.P.O.** in the mod manager, open or create a mod profile, then browse and install the mods you want.

4. **Launch and play**:
Start **R.E.P.O.** through the mod manager to load your mods and enjoy the game.
...
You can start by looking at the methods outlined in the [Developing Mods](./develop.md) page to determine what would fit your needs!
